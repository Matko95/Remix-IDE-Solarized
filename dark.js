javascript:(function () {
  document.getElementById('input').classList += 'ace-solarized-dark';
  document.head.innerHTML += `<style>
  .container_iXPop, .header_27fI2L, .tabsbar_U8oth, .contextviewcontainer_U8oth, #optionViews{
    background-color: #01313f;
  }
  .contextviewcontainer_U8oth, #files .file, .bar_2jr98x, .active_wDDb4{
    background-color: #596E75;
  }
  .folder_D3puG, .file_D3puG, .fa, .opts_li_27fI2L, #files .file, .changeeditorfontsize_U8oth i{
    color: #93A1A1;
  }
  .sol.warning{
    color: #fff;
  }
  #files .file.active, .active_wDDb4{
    color: #EEE8D6;
  }
